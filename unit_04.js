//https://www.youtube.com/watch?v=TbkL329h5bg   новое видео по этой тематике от Александра
...
function f1() {
	let t1 = document.querySelector('.b-1');
	t1 = 1;
...
function f2() {
	let t2 = document.querySelector('.i-2');
	t2 = 2;
...
function f3() {
	let t3 = document.querySelector('.p-3');
	t3 = 3;
...
// Функция проверяет состояние.i - 5 и если он checked - выводит value 
// данного элемента, если не выбран - false.Вывод везде в задачах, 
...
function f5() {
	...
	if (i5.checked) {
		document.querySelector('.out-5').innerHTML = 'checkbox i - 5';
	} else {
...
// Функция с помощью innerHTML создает в.out - 8 новый div с классом "js2" и 
// текстом "new div".Нажали несколько раз ? Создаем несколько раз!

function f8() {
	const div = document.createElement('div');
	div.classList.add('js2');
	const out8 = document.querySelector('.out-8')
	out8.appendChild(div).innerHTML = 'new div';
	console.log(out8);
}
...
// Функция проверяет checked элемента.r - 9. Если элемент выбран(checked) 
// то выводит в.out - 9 value radiobutton.Если не выбран - выводит false.
...
// Функция получает из.i - 10 значение цвета и окрашивает 
// style.background элемента.out - 10 в этот цвет.
...
// Функция получает цвет из.i - 111 и присваивает как value 
// элементу.i - 112. Т.е.после нажатия кнопки выбранный цвета 
// в первом и втором input станут одинаковые.
...
// Task 13
//  При изменении положения ползунка .i-13 выводите его значение 
// в out - 13. Обратите внимание на событие.
...
// Task 15
// При нажатии кнопки .b-15 функция должна выводить текст из .i-15 
// в textarea.t - 15 и в.out - 15.
...
// Task 16
// При нажатии на кнопку .b-16 выводите в .out-16 value 
// выбранного option из.s - 16.
...
// Task 19
// На странице создан div.out-19. По нажатию кнопки, 
// получите из него текст и присвойте в value элемента.i - 19.
...
// Task 20
// У вас есть два select. Напишите код, который при изменении 
// select.s - 201 будет аналогично изменять выбранный option в.s - 202.

function f20() {
	let s201 = document.querySelector('.s-201');
	let s202 = document.querySelector('.s-202');
	s202.value = s201.value;
	console.log(document.querySelector('.s-201').value);
}
